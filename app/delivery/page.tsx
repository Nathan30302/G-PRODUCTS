...
export default function DeliveryPage() {
  return (
    <PolicyLayout title="Delivery & Pickup" eyebrow="Help">
      ...
      <h2 className="display !mt-8 text-xl text-white">Free campus delivery</h2>
      <p>
      ...
      <h2 className="display !mt-8 text-xl text-white">Pickup</h2>
      <p>Collect from any of our shop locations:</p>
      <ul className="list-disc space-y-1 pl-5">
        {siteConfig.locations.map((l) => (
          <li key={l.id}>
            <strong className="text-white/80">{l.name}</strong> — {l.address}
          </li>
        ))}
      </ul>

      <h2 className="display !mt-8 text-xl text-white">Lusaka &amp; nationwide</h2>
      <p>
      ...
      <h2 className="display !mt-8 text-xl text-white">Typical timing</h2>
      <ul className="list-disc space-y-1 pl-5">
