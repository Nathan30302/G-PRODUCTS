        ...
        return (
          <DeskPanel key={loc.id}>
            <DeskPanelHeader
              ...
              action={
                <span className="shrink-0 rounded-pill border border-gp-border bg-gp-muted/50 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-gp-text-subtle">
                  {urls.length
