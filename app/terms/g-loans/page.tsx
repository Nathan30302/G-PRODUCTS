...
export default function GLoansTermsPage() {
  return (
    <PolicyLayout title="G-Loans Terms" eyebrow="Company">
      ...
      <h2 className="display !mt-8 text-xl">How it works</h2>
      ...
      <h2 className="display !mt-8 text-xl">Your responsibilities</h2>
      ...
      <h2 className="display !mt-8 text-xl">Important</h2>
      <p>
