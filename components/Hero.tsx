...
/** Homepage welcome — Heart Gladdening Products branding, no blocking splash. */
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="container-g relative flex flex-col justify-center py-10 sm:py-14 lg:py-16">
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center text-center">
          ...
          <h1 className="hero-rise hero-rise-delay-1 display mt-4 max-w-[14ch] text-[2rem] leading-[1.1] text-white sm:max-w-none sm:text-[2.75rem] lg:text-[3.25rem]">
            {siteConfig.tagline}
          </h1>

          <p className="hero-rise hero-rise-delay-1 mt-3 text-base font-semibold text-white/90 sm:text-lg">
            {siteConfig.headline}
          </p>

          <p className="hero-rise hero-rise-delay-2 mt-3 max-w-2xl text-sm leading-relaxed text-white/60 sm:text-base">
          ...
          <ul className="hero-rise hero-rise-delay-2 mt-5 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-xs font-medium text-white/45 sm:text-sm">
          ...
          <div className="hero-rise hero-rise-delay-3 mt-8 w-full max-w-xl sm:max-w-2xl">
            <div className="rounded-[1.75rem] border border-white/10 bg-gradient-to-b from-white/[0.07] to-white/[0.03] p-2 shadow-[0_20px_50px_rgba(0,0,0,0.35)] backdrop-blur-md">
              <div className="flex flex-col gap-2 sm:flex-row">
                <Link
                  href="/search"
                  className="btn-brand flex min-h-[3rem] flex-1 items-center justify-center gap-2 px-6 py-3.5 text-base font-bold sm:min-h-[3.25rem]"
                >
                  Shop products
                ...
                <a
                  ...
                  className="inline-flex min-h-[3rem] flex-1 items-center justify-center gap-2.5 rounded-pill border border-accent/35 bg-accent/10 px-6 py-3.5 text-base font-bold text-white transition-all duration-200 ease-out-expo hover:-translate-y-0.5 hover:border-accent/55 hover:bg-accent/20 sm:min-h-[3.25rem]"
                >
