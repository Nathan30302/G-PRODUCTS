...
export function CategoryTile({ category }: { category: Category }) {
  return (
    <Link
      ...
      className="group flex flex-col items-center gap-2.5 rounded-[1.35rem] border border-white/[0.07] bg-ink-900/80 p-4 text-center shadow-card transition-all duration-300 ease-out-expo hover:-translate-y-1 hover:border-brand/35 hover:bg-ink-850/80 hover:shadow-brand-glow sm:p-5"
    >
