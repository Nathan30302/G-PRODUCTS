      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        {catalogGroups.filter((g) => !g.href).map((g) => (
          <Link
            ...
            className="group flex min-h-[8.5rem] flex-col items-center gap-2.5 rounded-[1.4rem] border border-white/[0.06] bg-ink-900/60 px-2.5 py-4 text-center transition-all duration-400 ease-out-expo hover:border-brand/35 hover:bg-ink-850/80 sm:min-h-0 sm:gap-3 sm:px-4 sm:py-6"
          >
