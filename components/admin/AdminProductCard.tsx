    ...
    <article className="group relative flex flex-col overflow-hidden rounded-[1.35rem] border border-gp-border/70 bg-gp-surface shadow-card transition-all duration-300 ease-out-expo hover:-translate-y-0.5 hover:border-ink-700/25 hover:shadow-card-hover active:translate-y-0 active:scale-[0.995]">
        ...
        <div className="pointer-events-none absolute bottom-3 left-3 right-3 flex items-end justify-between gap-2">
          <span
            className={`rounded-pill px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide ${
              !inStock
                ? "bg-white/10 text-gp-text-muted"
                : lowStock
                  ? "bg-brand/20 text-accent-ink ring-1 ring-brand/30"
          ...
          {product.variants.length > 0 && (
            <div className="flex -space-x-1">
              ...
              {product.variants.length > 4 && (
                <span className="grid h-5 w-5 place-items-center rounded-full bg-white/10 text-[9px] font-bold text-gp-text-muted ring-2 ring-ink-950">
                  +{product.variants.length - 4}
                </span>
              )}
            </div>
      ...
      <div className="relative z-[2] flex flex-1 flex-col p-4 pointer-events-none">
        ...
        <div className="mt-4 flex items-center justify-between gap-2 pointer-events-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-accent-ink opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          ...
          <Link
            ...
            className="relative z-[3] inline-flex items-center justify-center rounded-pill border border-gp-border bg-gp-muted/50 px-3 py-2 text-gp-text-muted transition-colors hover:border-brand/30 hover:text-accent-ink"
