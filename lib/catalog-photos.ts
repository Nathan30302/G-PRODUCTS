...
> = {
  ...
  "phone-pouch": [
    ...
    { name: "Midnight", colorHex: "#0f172a", quantity: 8 },
    { name: "Pink", colorHex: "#ec4899", quantity: 10 },
    { name: "Hot Pink", colorHex: "#db2777", quantity: 8 },
    { name: "Red", colorHex: "#dc2626", quantity: 10 },
    { name: "Coral", colorHex: "#f97316", quantity: 8 },
    { name: "Orange", colorHex: "#ea580c", quantity: 8 },
    { name: "Yellow", colorHex: "#eab308", quantity: 8 },
    { name: "Mint", colorHex: "#6ee7b7", quantity: 8 },
    { name: "Teal", colorHex: "#0d9488", quantity: 8 },
    { name: "Green", colorHex: "#16a34a", quantity: 8 },
    { name: "Purple", colorHex: "#7c3aed", quantity: 8 },
    { name: "Lilac", colorHex: "#c4b5fd", quantity: 8 },
    { name: "White", colorHex: "#f5f5f5", quantity: 10 },
    { name: "Grey", colorHex: "#9ca3af", quantity: 8 }
  ],
  "bic-crystal-pen": [
...
export const commonsSearch: Record<string, string> = {
  ...
  "phone-pouch-midnight": "midnight silicone iPhone case",
  "phone-pouch-hot-pink": "hot pink silicone iPhone case",
  "phone-pouch-coral": "coral silicone iPhone case",
  "phone-pouch-orange": "orange silicone iPhone case",
  "phone-pouch-yellow": "yellow silicone iPhone case",
  "phone-pouch-mint": "mint silicone iPhone case",
  "phone-pouch-green": "green silicone iPhone case",
  "phone-pouch-purple": "purple silicone iPhone case",
  "phone-pouch-lilac": "lilac silicone iPhone case",
  "phone-pouch-white": "white silicone iPhone case",
  "phone-pouch-grey": "grey silicone iPhone case",
  ...
  "extension-cable": "PK TRUSTS UK Type G trailing socket extension lead",
